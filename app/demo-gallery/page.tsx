      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <section className="mb-16">
          ...
          <p className="mt-3 text-base leading-7 text-gray-600">
            「これあったら絶対使う」 と思うものを<strong>最大 3 つ</strong>選んで、 お立場と一緒に送ってください。 1〜2 分で済みます。
          </p>
          <p className="mt-3 text-base leading-7 text-gray-600">
            <strong>全部いらない場合は、 投票はせず、 下に出てくる「いらない理由」 を選ぶだけで送信できます。</strong> 「なぜ刺さらなかったか」 は今のあなたの仕事の進め方を教えてくれる、 一番ありがたい情報です。
          </p>
        </section>
