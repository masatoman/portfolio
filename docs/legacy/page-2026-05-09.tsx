          ...
          <div className="container mx-auto grid lg:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-14 items-center">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <Button asChild variant="outline" className="h-12 px-6 rounded-full bg-white border-slate-300 hover:border-brand-accent text-slate-700 hover:text-brand-accent text-sm font-bold">
                  <Link href="/local-business">
                    工務店・中小企業向けはこちら
                  </Link>
                </Button>
              </div>
